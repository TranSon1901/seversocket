...
io.on('connection', (socket) => {
   ...
   socket.on("socket_message_send", ({uid_user, uid_friend, message, id_message, username, img}) => {
      ...
      if(uid_socket_friend != ""){
         ...
         io.to(uid_socket_friend).emit("socket_message_come", {uid_user, message, uid_friend, id_message, username, img});
      }
